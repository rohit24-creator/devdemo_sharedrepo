      ...
      <header className="bg-white shadow-sm border-b border-gray-200">
        <div className="flex flex-col sm:flex-row items-center justify-between px-4 sm:px-8 py-4 sm:py-6 space-y-4 sm:space-y-0">
          <div className="flex items-center">
            <h1 className="text-2xl sm:text-4xl font-bold text-[#006397]">ShipmentX</h1>
          </div>
          <div className="flex flex-col sm:flex-row items-center space-y-3 sm:space-y-0 sm:space-x-4 w-full sm:w-auto">
            ...
            />
            <Button className="bg-[#006397] hover:bg-[#02abf5] px-8 w-full sm:w-auto">
              Track
            </Button>
          </div>
        </div>
      ...
      <section className="bg-gradient-to-r from-slate-300 to-gray-100 px-4 sm:px-8 py-4 sm:py-6">
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-8">
          <div className="flex items-center space-x-3 sm:space-x-4">
            ...
            <div>
              <p className="text-xs sm:text-sm font-medium text-gray-600">Tracking Reference</p>
          ...
          <div className="flex items-center space-x-3 sm:space-x-4">
            ...
            <div>
              <p className="text-xs sm:text-sm font-medium text-gray-600">Order Type</p>
          ...
          <div className="flex items-center space-x-3 sm:space-x-4">
            ...
            <div>
              <p className="text-xs sm:text-sm font-medium text-gray-600">Booked By Supplier</p>
      ...
      <main className="p-3 sm:p-6">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 sm:gap-6">
          ...
          <div className="lg:col-span-3 order-2 lg:order-1">
            <Card className="border-0 shadow-lg bg-gradient-to-br from-white to-slate-50 h-[600px] sm:h-[700px] lg:h-[850px]">
              <CardHeader className="pb-2">
                <CardTitle className="flex items-center space-x-3 text-base sm:text-lg font-bold text-gray-800">
                  ...
                  <span className="text-gray-800 font-bold tracking-wide text-sm sm:text-base">ROUTING INFORMATION</span>
                </CardTitle>
              </CardHeader>
              <CardContent className="pt-0">
                ...
                <div className="mt-6 sm:mt-8">
                  <div className="flex items-center space-x-3 mb-4 sm:mb-6">
                    ...
                    <h3 className="text-base sm:text-lg font-bold text-gray-800 tracking-wide">TRANSIT STATUS</h3>
                  </div>

                  {transitEvents.length === 0 ? (
                    <div className="text-center py-6 sm:py-8">
                      <p className="text-gray-500 text-xs sm:text-sm font-medium">No Transit Events</p>
                    </div>
                  ) : (
                        ...
                        <div key={event.id} className="relative">
                          <div className="flex items-start space-x-3 sm:space-x-4">
                            <div className="flex flex-col items-center">
                              <div className={`w-5 h-5 sm:w-6 sm:h-6 rounded-full flex items-center justify-center shadow-lg ${
                                event.completed ? 'bg-gradient-to-r from-sky-500 to-blue-500' : 'bg-gray-300'
                              }`}>
                                {event.completed && (
                              ...
                              {index < transitEvents.length - 1 && (
                                <div className="w-1 h-8 sm:h-12 bg-gradient-to-b from-sky-500 to-blue-500 mt-2"></div>
                              )}
                            </div>
                            <div className="flex-1 pb-4 sm:pb-6">
                              <p className="font-semibold text-xs sm:text-sm text-gray-800">{event.status}</p>
                              <p className="text-xs text-gray-500 mt-1">{event.date}</p>
                              <div className="flex flex-col sm:flex-row sm:items-center space-y-1 sm:space-y-0 sm:space-x-3 mt-2">
                                <Badge variant="secondary" className="bg-sky-100 text-sky-800 text-xs w-fit">
                                  {event.type}
                                </Badge>
                                <span className="text-xs text-gray-600">{event.items}</span>
                                <span className="text-xs text-gray-600">{event.weight}</span>
                              </div>
                            </div>
                          </div>
                        </div>
          ...
          <div className="lg:col-span-6 order-1 lg:order-2">
            <Card className="p-4 min-h-[750px]">
              <CardContent className="p-0 pb-6 space-y-4">
                {/* Map */}
                <div className="w-full h-[600px] sm:h-[700px] lg:h-[700px]">
                  <iframe
                    title="map"
            ...
            <div className="mt-3 p-4 bg-white rounded-md shadow-sm">
              ...
              <p className="text-lg font-semibold text-green-600">In Transit</p>
            </div>
          </div>
              ...
              <Card>
                <CardHeader className="pb-2">
                  <CardTitle className="flex items-center space-x-3 text-base sm:text-lg font-bold text-gray-800">
                    ...
                    <span className="text-gray-800 font-bold tracking-wide text-sm sm:text-base">SHIPMENT OVERVIEW</span>
                  </CardTitle>
                </CardHeader>
                <CardContent className="space-y-3 sm:space-y-4">
                  <div className="flex items-start space-x-3">
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="font-semibold text-xs sm:text-sm text-gray-800 mb-1">Pickup Address</p>
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="font-semibold text-xs sm:text-sm text-gray-800 mb-1">Delivery Address</p>
                      <p className="text-xs sm:text-sm text-gray-600 leading-relaxed">
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="font-semibold text-xs sm:text-sm text-gray-800 mb-1">Pickup And Delivery</p>
              ...
              <Card>
                <CardHeader className="pb-2">
                  <CardTitle className="flex items-center space-x-3 text-base sm:text-lg font-bold text-gray-800">
                    ...
                    <span className="text-gray-800 font-bold tracking-wide text-sm sm:text-base">PACKAGE DETAILS</span>
                  </CardTitle>
                </CardHeader>
                <CardContent className="space-y-3">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-3">
                      ...
                      <span className="text-xs sm:text-sm font-medium text-gray-700">Number Of Packages</span>
                    </div>
                    <span className="font-bold text-base sm:text-lg text-gray-800">{trackingData.packages}</span>
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-3">
                      ...
                      <span className="text-xs sm:text-sm font-medium text-gray-700">Volume</span>
                    </div>
                    <span className="font-bold text-base sm:text-lg text-gray-800">{trackingData.volume}</span>
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-3">
                      ...
                      <span className="text-xs sm:text-sm font-medium text-gray-700">Weight</span>
                    </div>
                    <span className="font-bold text-base sm:text-lg text-gray-800">{trackingData.weight}</span>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card>
                <CardHeader className="pb-2">
                  <CardTitle className="flex items-center space-x-3 text-base sm:text-lg font-bold text-gray-800">
                    ...
                    <span className="text-gray-800 font-bold tracking-wide text-sm sm:text-base">ADDITIONAL INFO</span>
                  </CardTitle>
                </CardHeader>
                <CardContent className="space-y-3">
                  <div className="flex items-center justify-between">
                    <span className="text-xs sm:text-sm font-medium text-gray-700">Bill Of Lading</span>
                    <span className="font-bold text-base sm:text-lg text-gray-400">N/A</span>
                  </div>

                  <div className="flex items-center justify-between">
                    <span className="text-xs sm:text-sm font-medium text-gray-700">Invoice No</span>
                    <span className="font-bold text-base sm:text-lg text-gray-400">N/A</span>
                  </div>
                </CardContent>
              </Card>
      ...
      <footer className="bg-white border-t border-gray-200">
        <div className="px-4 sm:px-8 py-6 sm:py-8">
          <div className="flex items-center space-x-3 mb-4 sm:mb-6">
            ...
            <h2 className="text-base sm:text-lg font-bold text-gray-800 tracking-wide">VEHICLE INFORMATION</h2>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-8">
            <div className="flex items-start space-x-3 sm:space-x-4">
              ...
              <div className="flex-1">
                <p className="font-semibold text-xs sm:text-sm text-gray-800 mb-1 sm:mb-2">Vehicle Type</p>
                <p className="text-xs sm:text-sm text-gray-600 leading-relaxed">
            ...
            <div className="flex items-start space-x-3 sm:space-x-4">
              ...
              <div className="flex-1">
                <p className="font-semibold text-xs sm:text-sm text-gray-800 mb-1 sm:mb-2">Vehicle Location</p>
                <p className="text-xs sm:text-sm text-gray-600 leading-relaxed">
            ...
            <div className="flex items-start space-x-3 sm:space-x-4 sm:col-span-2 lg:col-span-1">
              ...
              <div className="flex-1">
                <p className="font-semibold text-xs sm:text-sm text-gray-800 mb-1 sm:mb-2">Vehicle Delivery Location</p>
                <p className="text-xs sm:text-sm text-gray-600 leading-relaxed">
