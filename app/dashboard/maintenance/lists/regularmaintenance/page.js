...
export default function RegularMaintenancePage() {
  ...
  const secondIconMenu = [
    { label: "+ Add New", onClick: () => router.push(DASHBOARD_ROUTES.regularMaintenance) },
    { label: "Maintenance Template", onClick: () => console.log("Maintenance Template") },
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const { data } = await api.get("/dashboard/maintenance/regularMaintenance.json");
