...
export default function AddPurchaseOrderPage() {
  ...
  const secondIconMenu = [
    { label: "+ Add New", onClick: () => router.push(DASHBOARD_ROUTES.addPurchaseOrder) },
    { label: "Purchase Order Template", onClick: () => console.log("Purchase Order Template") },
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const { data } = await api.get("/dashboard/maintenance/addPurchaseOrder.json");
